...
const ChairDetails = ({ navigation, route }) => {
    ...
    function renderChairInfo() {
        return (
            ...
            >
                {
                    chairbrands?.menu.map((item, index) => (
                        <View
                            key={`menu-${index}`}
                        ...
                        >
                            ...
                            >
                                <Text style={{ marginVertical: 10, textAlign: 'center', ...FONTS.h2, color:COLORS.primary }}>{item.name} - ${item.price.toFixed(2)}</Text>
                            ...
                            >
                                ...
                                }}>{item.durability.toFixed(2)} strength</Text>
                            </View>
                        </View>
                    ))
                }
                ...
                >
                    ...
                    >
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4 }}>10,000</Text>
                        </View>
                    </View>
